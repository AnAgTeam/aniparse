...
- [ ] Маршрутизация URL: библиотеке даётся ссылка — она сама находит парсер и контент
- [ ] Data-driven каталог источников: зеркала доменов и волатильные селекторы обновляются в рантайме — сломанный источник чинится без релиза приложения
