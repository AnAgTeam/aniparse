 ...
 * info()/items() are served from the cached mapping with no extra fetch; from a URL
 * or serialized id alone, the first info()/items() resolves the post and caches it.
 */
